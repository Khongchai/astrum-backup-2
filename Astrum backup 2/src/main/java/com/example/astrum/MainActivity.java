...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        fragmenttransaction.add(R.id.FragmentsContainer, new openadjustvolume());
        fragmenttransaction.commit();

        //transition
       // TransitionManager.beginDelayedTransition(R.id.FragmentsContainer);
            ...
            public void onClick(View v)
            {
                ...
                if (check == true)
                {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        ...
                        //for some reasons MediaPLayer.start with a variable in it does not work
                    }
                    check = false;
                }
                else
